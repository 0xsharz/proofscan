...
"""Report stage: exploitability analysis of a verified finding.
...
from .artifacts import FindingArtifact, ReportVerdict
...
async def run_report(
    ...
    with sandbox.agent_container(target.image_tag, container_name, agent_env) as container:
        ...
        adapted_cmd = finding.reproduction_command.replace(finding.poc_path, "/tmp/poc.bin")

        os.makedirs(workspace_dir, exist_ok=True)
        with open(os.path.join(workspace_dir, "poc.bin"), "wb") as f:
            f.write(finding.poc_bytes)
        ...
        prompt = build_report_prompt(
            ...
            finding_evidence=finding.finding_evidence,
